...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("qual sua distância até o cumplice?: ");
        int.TryParse(Console.ReadLine(), out cumplice);

        int total = Some(cumplice, energia, ameaca);
        Console.ReadLine();
    ...
    static int Some(int cumplice, int energia, string? ameaca)
    {
